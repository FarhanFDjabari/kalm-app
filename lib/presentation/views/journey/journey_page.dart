...
import 'package:kalm/presentation/views/journey/journey_detail_page.dart';
import 'package:kalm/presentation/widgets/kalm_button.dart';
import 'package:kalm/presentation/widgets/kalm_journey_image_card.dart';
...
class _JourneyPageState extends State<JourneyPage>
  ...
  void initState() {
    context
        .read<JourneyCubit>()
        .fetchAllJourney(GetStorage().read('user_id') ?? 0);
    super.initState();
  }
                        ...
                        child: BlocBuilder<JourneyCubit, JourneyState>(
                          builder: (context, state) {
                            if (state is JourneyLoaded) {
                              if (state.journeyList.isNotEmpty) {
                                return Swiper(
                                ...
                                return Center(
                                  child:
                                      Text('Belum ada jurnal yang dapat diisi'),
                                );
                              }
                            } else
                              return Container(
