...
class _JourneyChapterPageState extends State<JourneyChapterPage> {
  ...
  JournalItemEntity? _journalItemData;
    ...
    return Container(
      child: BlocListener<JourneyCubit, JourneyState>(
        listener: (context, state) {
          ...
          } else if (state is JourneyTaskLoaded) {
            _journalItemData = state.journeyTask;
                    ...
                    Expanded(
                      child: Form(
                        ...
                        child: PageView.builder(
                            itemCount: _journalItemData?.questions.length ?? 0,
                            ...
                            itemBuilder: (_, index) {
                              QuestionEntity? question =
                                  _journalItemData?.questions[index];
